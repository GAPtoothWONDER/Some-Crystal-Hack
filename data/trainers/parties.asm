...
FalknerGroup:
	...
	db  9, HOOTHOOT,     TACKLE, CONFUSION, NO_MOVE, NO_MOVE
...
ClairGroup:
	...
	db 38, GYARADOS,   HYDRO_PUMP, ICE_BEAM, BITE, DRAGONBREATH
...
WillGroup:
	...
	db 42, GIRAFARIG,  CRUNCH, FUTURE_SIGHT, HIDDEN_POWER, PSYCHIC_M
	db -1 ; end
...
BlueGroup:
	...
	db 58, ARCANINE,   PLAY_ROUGH, SWIFT, FLAMETHROWER, EXTREMESPEED
	db -1 ; end
